    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2000, 10, 10), new DateTime(2024, 11, 19, 11, 3, 29, 602, DateTimeKind.Local).AddTicks(4192), "ewabak@gmail.com", "ewa", "bak", 101, "497290407" },
                    { 2, new DateOnly(1997, 10, 10), new DateTime(2024, 11, 19, 11, 3, 29, 602, DateTimeKind.Local).AddTicks(4236), "vbsruihbuiwhak@gmail.com", "flf", "bhfyuk", 102, "497085668" }
                });
